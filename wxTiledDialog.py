#Boa:Dialog:wxTiledDialog

from wxPython.wx import *

def create(parent):
    return wxTiledDialog(parent)

[wxID_WXTILEDDIALOG, wxID_WXTILEDDIALOGBUTTONSAVEJPG, 
 wxID_WXTILEDDIALOGBUTTONSAVEPNG, wxID_WXTILEDDIALOGSTATICBITMAPTILEDLAYER, 
] = map(lambda _init_ctrls: wxNewId(), range(4))

class wxTiledDialog(wxDialog):
    def _init_ctrls(self, prnt):
        # generated method, don't edit
        wxDialog.__init__(self, id=wxID_WXTILEDDIALOG, name='wxTiledDialog',
        ...
        self.buttonSavePNG = wxButton(id=wxID_WXTILEDDIALOGBUTTONSAVEPNG,
        ...
        EVT_BUTTON(self.buttonSavePNG, wxID_WXTILEDDIALOGBUTTONSAVEPNG,
              self.OnButtonSavePNGButton)

        self.buttonSaveJPG = wxButton(id=wxID_WXTILEDDIALOGBUTTONSAVEJPG,
        ...
        EVT_BUTTON(self.buttonSaveJPG, wxID_WXTILEDDIALOGBUTTONSAVEJPG,
              self.OnButtonSaveJPGButton)

        self.staticBitmapTiledLayer = wxStaticBitmap(bitmap=wxNullBitmap,
              id=wxID_WXTILEDDIALOGSTATICBITMAPTILEDLAYER,
